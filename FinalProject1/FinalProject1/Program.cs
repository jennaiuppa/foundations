...
class MyInventory
{
    public static void Main()
    {
        ...
        itemdata[0].itemIDNo = 0;
        itemdata[1].sDescription = null;
        itemdata[2].dblPricePerItem = 0;
        itemdata[3].iQuantityOnHand = 0;
        itemdata[4].dblOurCostPerItem = 0;
        itemdata[5].dblValueOfItem = 0;

        int icount = itemdata.Length;
